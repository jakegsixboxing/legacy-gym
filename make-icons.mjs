...
for (const f of ['index.html', 'manifest.json', 'sw.js', 'spring-challenge.html', 'coaches.html', 'sarsha-mcgurk.html', 'fight-club.jpg', 'joe-williams.html', 'sarsha.html', 'jake-pt.mp4']) {
