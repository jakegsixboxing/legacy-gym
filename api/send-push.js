...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Staff-only: enforced server-side by the get_push_subscriptions() RPC (security definer, checks is_staff internally).
    const subs = await fetch(SB_URL + "/rest/v1/rpc/get_push_subscriptions", {
